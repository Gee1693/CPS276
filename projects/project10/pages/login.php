...
if(isset($_POST['login'])){
  ...
  if($_POST['email'] === $_POST['email'] && $_POST['password'] === "password"){
...
$form = <<<HTML
    ...
    <!--<div class="form-group">
      <label for="name">Email Address {$elementsArr['email']['errorOutput']}</label>
      <input type="name" class="form-control" id="name" name="name" value="{$elementsArr['email']['value']}" >
    </div>-->
