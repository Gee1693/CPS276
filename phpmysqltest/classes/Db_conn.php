...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'gmartinjr';//this will be your WCC username
      $dbUsr = 'gmartinjr';//this will be your WCC username
      $dbPass = 'jGZHaQ93ZG7G';//this will be the password found in the video.
